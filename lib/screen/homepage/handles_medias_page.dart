...
class _HandlesMediasPageState extends State<HandlesMediasPage>
    ...
    return MaterialApp(
        ...
        home: DefaultTabController(
          ...
          child: Consumer(builder: (ctx, watch, child) {
            final _singleHandlesProvider =
                watch(singleHandlesProvider(widget.handlesID));
                          ...
                          builder: (context, snapshot) {
                            ...
                            if (snapshot.hasData) {
                              snapshot.data!.forEach((element) {
                                if (element.mediaURL != "" &&
                                    element.deletedBy
                                            .indexOf(widget.currentUserID) <
                                        0) {
                                  mediaChatTimestamps.add(element.timestamp
                                      .toString()
                                      .substring(0, 10));
                                }
                              });
                            ...
                            return snapshot.hasData && isEmpty == false
                                ? ListView.builder(
                                    shrinkWrap: false,
                                    itemCount: chatsByDate
                                        .reversed.length, //day separator
                                          ...
                                          Container(
                                            ...
                                            padding: EdgeInsets.only(
                                                ...
                                                left: MQuery.height(
                                                    0.015, context)),
                                            child: Text(
                                              DateTime.parse(mediaChatTimestamps
                                                              .toList()
                                                              .reversed
                                                              .toList()[index])
                                                          .day ==
                                            ...
                                            child: GridView.builder(
                                                gridDelegate:
                                                    SliverGridDelegateWithMaxCrossAxisExtent(
                                                        ...
                                                        crossAxisSpacing: 0,
                                                        mainAxisSpacing: 0),
                                                itemCount: chatsByDate.reversed
                                                    .toList()[index]
                                                    .length,
                                                itemBuilder:
                                                  ...
                                                  return GestureDetector(
                                                    onTap: () {
                                                      _userProvider
                                                        ...
                                                        Get.to(() => ImagePreviewer(
                                                            imageURL: chatsByDate
                                                                    .reversed
                                                                    .toList()[index]
                                                                        [index2]
                                                                    .mediaURL ??
                                                                "",
                                                            timeStamp: chatsByDate
                                                                .reversed
                                                                .toList()[index]
                                                                    [index2]
                                                                .timestamp,
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Hero(
                                                        tag: "img:$index2",
                                                        child: Image(
                                                            image: NetworkImage(chatsByDate
                                                                    .reversed
                                                                    .toList()[
                                                                        index]
                                                                        [index2]
                                                      ...
                                                      child: Container(
                                                          child: AspectRatio(
                                                              ...
                                                              child:
                                                                  FutureBuilder<
                                                                      String?>(
                                                                future: getThumbnail(chatsByDate
                                                                        .reversed
                                                                        .toList()[
                                                                            index]
                                                                            [
                                                                  ...
                                                                  return snapshot
                                                                      ...
                                                                      ? Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Positioned.fill(
                                                                                child: Image.file(File(snapshot.data ?? ""), fit: BoxFit.fill),
                                                                              ),
                                                                              Container(
                                                                              ...
                                                                              AdaptiveIcon(android: Icons.play_arrow_rounded, iOS: CupertinoIcons.play_arrow_solid, size: 32, color: Colors.white)
                                                                            ],
                                                                          ))
                                                                      : Container(
                                                                          width: MQuery.width(
                                                                ...
                                                                maxWidth: MQuery.width(
                                                                    currentChat.mediaURL!.length >= 30
                                                                        ...
                                                                        : currentChat.mediaURL!.length <= 12
                                                                            ? 0.15
                                                                            : currentChat.mediaURL!.length * 0.009,
                                                                    context),
                                                                              ...
                                                                              builder: (context, snapshot) {
                                                                                return snapshot.hasData
                                                                                    ? Text(
                                                                                        snapshot.data ?? "",
                                                                                        textAlign: TextAlign.start,
                                                                                        style: TextStyle(color: Colors.white.withOpacity(0.5), fontWeight: FontWeight.w400, fontSize: 12),
                                                                                      )
                                                                                    : SizedBox();
                                                                              }),
                                                                          SizedBox(
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            padding:
                                                                                EdgeInsets.only(left: MQuery.width(0.01, context)),
                                                                            child:
                                                                                Row(
                                                                                ...
                                                                                Row(
                                                                                  children: [
                                                                                    ...
                                                                                    FutureBuilder<String?>(
                                                                                        ...
                                                                                        builder: (context, snapshot) {
                                                                                          return snapshot.hasData ? Text(snapshot.data!.length >= 23 ? snapshot.data!.substring(0, 20) + "..." : snapshot.data!, style: TextStyle(color: Colors.black, fontWeight: FontWeight.w400, fontSize: 14)) : SizedBox();
                                                                                        }),
                                                                                  ],
                                                                                ),
                                                                                IconButton(
                                                                                  ...
                                                                                  icon: isExist ? AdaptiveIcon(android: Icons.folder_open, iOS: CupertinoIcons.folder_fill, size: 18, color: Palette.primary) : AdaptiveIcon(android: Icons.download, iOS: CupertinoIcons.cloud_download_fill, size: 18, color: Palette.primary),
                                                                                )
                                                                              ],
                                                                            ),
                                                                          )
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: ListView.builder(
                                              ...
                                              itemBuilder: (BuildContext ctx, index2) {
                                                ChatModel currentChat = chatsByDate.reversed.toList()[index][index2];
                                                return watch(meetChatProvider(currentChat.id)).when(
                                                  data: (meetChat){
                                                    return MeetingChat(
                                                      handlesID: handles.id,
                                                      index: index,
                                                      ...
                                                      senderRole: handles.members[currentChat.sender] == "Members"
                                                        ? ""
                                                        : handles.members[currentChat.sender] ?? "",
                                                      isRecurring: true,
