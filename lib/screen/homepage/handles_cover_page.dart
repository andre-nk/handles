...
class HandlesCoverPage extends StatefulWidget {
  ...
  const HandlesCoverPage(
      {Key? key,
      required this.handlesName,
      required this.handlesCoverURL,
    ...
    return Consumer(
      builder: (ctx, watch, child) {
        ...
        _imgFromCamera() async {
          ...
          setState(() {
            _profileImage = image;
            _handlesProvider.updateHandleCover(
                image!.path, widget.handlesName, widget.handlesID);
          });
        }
        ...
        return Scaffold(
            ...
            appBar: AppBar(
              centerTitle: false,
                ...
                title: Font.out(widget.handlesName,
                    fontSize: 16,
