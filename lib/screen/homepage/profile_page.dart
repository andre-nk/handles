                                    ...
                                    GestureDetector(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          (entitlement.data!.entitlements.all['pro'] != null && entitlement.data!.entitlements.all['pro']!.isActive == true) ||
                                          (entitlement.data!.entitlements.all['pro_unlimited'] != null && entitlement.data!.entitlements.all['pro_unlimited']!.isActive == true)
                                          ? Container(
                                              height: 27.5,
                                              width: 50,
                                              margin: EdgeInsets.only(left: MQuery.width(0.025, context)),
