                  ...
                  if (nameController.text != "") {
                    if (_image != null) {
                      _authenticationProvider
                        ...
                        if (_downloadURL != "") {
                          if (_authenticationProvider.auth.currentUser !=
                              null) {
                            _authenticationProvider.createUserRecord(UserModel(
                              id: _authenticationProvider.auth.currentUser!.uid,
                              name: nameController.text,
                              profilePicture: _downloadURL,
                              phoneNumber: _authenticationProvider
